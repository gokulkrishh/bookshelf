...
const ReactDOM = (function(la) {
  ...
  function Fa(a, b) {
    ...
    if (null === c) {
      ...
      (d = a.updateQueue),
        ...
        null === d
          ? null === e
            ? ((d = a.updateQueue = Sc(a.memoizedState)), (e = c.updateQueue = Sc(c.memoizedState)))
            : (d = a.updateQueue = ve(e))
          : null === e && (e = c.updateQueue = ve(d))
    null === e || d === e
      ? Tc(d, b)
  ...
  J(M.prototype, {
    preventDefault: function() {
      ...
      a &&
        (a.preventDefault ? a.preventDefault() : 'unknown' !== typeof a.returnValue && (a.returnValue = !1), (this.isDefaultPrevented = Bc))
    },
