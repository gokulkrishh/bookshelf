...
const React = (function() {
  ...
  function Aa(a, b, c) {
    ...
    Array.isArray(a)
      ...
      : null != a &&
        (O(a) && (a = wa(a, e + (!a.key || (b && b.key === a.key) ? '' : ('' + a.key).replace(na, '$&/') + '/') + c)), d.push(a))
  }
      ...
      if (c !== b) {
        ...
        a: for (var d = 0, e = a.length; d < e; ) {
          var f = 2 * (d + 1) - 1,
            ...
            k = a[g]
          if (void 0 !== h && 0 > E(h, c))
            void 0 !== k && 0 > E(k, h) ? ((a[d] = k), (a[g] = c), (d = g)) : ((a[d] = h), (a[f] = c), (d = f))
  ...
  J(C, {
    Scheduler: {
      ...
      unstable_shouldYield: function() {
        ...
        var b = n(q)
        return (
          (b !== l && null !== l && null !== b && null !== b.callback && b.startTime <= a && b.expirationTime < l.expirationTime) || X()
        )
      },
